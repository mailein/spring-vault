 ...
 */
public interface ReactiveVaultPkiOperations {
     ...
     */
    Mono<VaultCertificateResponse> issueCertificate(String roleName, VaultCertificateRequest certificateRequest)
     ...
     * @since 2.0
     */
    Mono<VaultSignCertificateRequestResponse> signCertificateRequest(String roleName, String csr,
     ...
     * @since 2.0
     */
    Mono<Void> revoke(String serialNumber) throws VaultException;
     ...
     */
    @Nullable
    Mono<InputStream> getCrl(Encoding encoding) throws VaultException;
     ...
     * @since 3.1
     */
    Mono<VaultIssuerCertificateRequestResponse> getIssuerCertificate(String issuer) throws VaultException;
     ...
     * @since 3.1
     */
    Mono<InputStream> getIssuerCertificate(String issuer, Encoding encoding) throws VaultException;
}
